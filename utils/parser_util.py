...
def add_model_options(parser):
    ...
    group.add_argument("--use_word_emb", action="store_true", default=False)
    group.add_argument("--num_code", default=1024, type=int)
    group.add_argument("--use_transformers_clip", action="store_true", default=False,
                       help="Use CLIP text model from transformers library.")
    ...
    # for cvae models
    group.add_argument("--rot_mse_w", default=1.0, type=float)
    group.add_argument("--xyz_mse_w", default=1.0, type=float)
    group.add_argument("--kld_w", default=1e-2, type=float)
    group.add_argument("--att_spa_w", default=1e-2, type=float)
    group.add_argument("--codebook_norm_w", default=1e-2, type=float)
