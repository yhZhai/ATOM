...
from data_loaders.humanml.motion_loaders.model_motion_loaders_cvae import (
    get_cvae_loader,
)
...
from utils.model_util import create_cvae_model, load_model_wo_clip
...
def evaluation(
    ...
    with open(log_file, "w") as f:
        ...
        for replication in range(replication_times):
            ...
            print(
                f"==================== Replication {replication} / {replication_times} ===================="
            )
            print(
                f"==================== Replication {replication} / {replication_times} ====================",
                file=f,
...
if __name__ == "__main__":
    ...
    model = create_cvae_model(args, gen_loader)
